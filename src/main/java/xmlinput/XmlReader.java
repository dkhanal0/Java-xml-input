...
public class XmlReader {
    ...
    public Product[] getProducts(){
        // Get the ArrayList of Products built by the handler and return an array
        Product[] productArray = new Product[myXmlHandler.getProducts().size()];
        productArray = myXmlHandler.getProducts().toArray(productArray);
    return productArray;
    }
}
